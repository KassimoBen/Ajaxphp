...
<head>
    ...
    <link rel="shortcut icon" href="../Progressus/assets/images/gt_favicon.png">
    ...
    table {
        ...
        border-color: black;
        top: 100px;
        /* background: rgb(202, 250, 113); */
        /* display:none; */
    }

    #entete {
        background-color: rgb(193, 244, 146);
        text-align: center;
        color: green;
    }
    </style>
    ...
    <div class="navbar navbar-inverse navbar-fixed-top headroom">
        <div class="container">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.html"><img src="../Progressus/assets/images/logo.png"
                        alt="Progressus HTML5 template"></a>
            </div>
            <div class="navbar-collapse collapse">
                <ul class="nav navbar-nav pull-right">
                    <li class="active"><a href="#">Home</a></li>
                    <li><a href="../tableau/tableau.html">Tableaux</a></li>
                    <li><a href="../Progressus/contact.html">Contact</a></li>
                    <li><a class="btn" href="../login/login.html">Deconnection</a></li>
                </ul>
            </div>
            <!--/.nav-collapse -->
        </div>
    ...
    <header id="head">
        ...
        ?>
                    ...
                    <tr id=<?php echo $row["id"]; ?>>
                        ...
                        <td>
                            <a href="edituser.php?id=<?php echo $row["id"]; ?>"><img src="../icone/mode_edit@2x.png"
                                    alt=""></a>
                            <button type="button" onclick="submitData(<?php echo $row['id']; ?>);"><img
                                    src="../icone/delete@2x.png" alt=""></button>
                        </td>
                    </tr>
                    <?php endforeach;?>
                </table>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 widget">
                        <div class="widget-body">
                            <p class="simplenav">
                                <a href="#">Home</a> |
                                <a href="../tableau/tableau.html">Tableaux</a> |
                                <a href="../Progressus/contact.html">Contact</a> |
                                <b><a href="../login/login.html">Deconnection</a></b>
                            </p>
                        </div>
                    </div>
